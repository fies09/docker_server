...
COMPOSE="/Users/fanyong/Desktop/code/python/docker_server/infra/docker-compose.yml"
...
docker compose --env-file /Users/fanyong/Desktop/code/python/docker_server/infra/.env -f "$COMPOSE" stop milvus neo4j
...
docker compose --env-file /Users/fanyong/Desktop/code/python/docker_server/infra/.env -f "$COMPOSE" up -d etcd minio
docker compose --env-file /Users/fanyong/Desktop/code/python/docker_server/infra/.env -f "$COMPOSE" up -d milvus neo4j

echo "DONE. verify:"
docker compose --env-file /Users/fanyong/Desktop/code/python/docker_server/infra/.env -f "$COMPOSE" ps